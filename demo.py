...
# Crea la gráfica de barras
fig_bar = px.bar(df_sales_year_category_subcategory, x='Order Date', y='Sales', color='Sub-Category',
                 facet_row='Category',  # Divide la gráfica por categoría
...
fig_bar = px.bar(
    ...
    color='Sub-Category',
    barmode='stack',  # Apila las barras por subcategoría
    facet_row='Category',  # Divide la gráfica por categoría en filas
...
# Crea la gráfica de barras con una clave única
fig = px.bar(df, x='Region', y=sales_column, title='Ventas por Región')
st.plotly_chart(fig, key="ventas_por_region")  # Asigna una clave única
...
# Gráfica de pastel con la columna 'Category' con una clave única
if 'Category' in filtered_df.columns:
    st.subheader('Gráfica de Pastel de Categorías')
    category_counts = filtered_df['Category'].value_counts()
    fig_pie = px.pie(category_counts, values=category_counts.values, names=category_counts.index, title='Distribución de Categorías')
    st.plotly_chart(fig_pie, key="grafica_pastel_categorias")  # Asigna una clave única
else:
    st.warning("La columna 'Category' no existe en el DataFrame. No se puede generar la gráfica de pastel.")
...
if 'Order Date' in df.columns:
    ...
    # Crea la gráfica de línea con una clave única
    fig_line = px.line(df_sales_year, x='Order Date', y='Sales', title='Acumulado de Ventas por Año')
    st.plotly_chart(fig_line, key="acumulado_ventas_año")  # Asigna una clave única
...
# Muestra la gráfica en Streamlit
st.plotly_chart(fig_bar, key="ventas_acumuladas_año_categoria_subcategoria")  # Asigna una clave única



# Crea la gráfica de barras apiladas por categoría y subcategoría con una clave única
fig_bar = px.bar(
    df_sales_year_category_subcategory,
    x='Order Date',
    y='Sales',
...
# Muestra la gráfica en Streamlit
st.plotly_chart(fig_bar, key="ventas_acumuladas_año_categoria_subcategoria_apiladas")  # Asigna una clave única
...
# Muestra la gráfica en Streamlit
st.plotly_chart(fig_bar, key="ventas_acumuladas_año_categoria")  # Asigna una clave única
